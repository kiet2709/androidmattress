    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OrderCompletedActivity.this, OrderActivity.class);
        ...
        btnInProgress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OrderCompletedActivity.this, OrderInProgressActivity.class);
                startActivity(intent);
            }
        });
        btnCompleted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OrderCompletedActivity.this, OrderCompletedActivity.class);
                startActivity(intent);
            }
        });
        ...
        userButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(OrderCompletedActivity.this, PersonalActivity.class);
                startActivity(intent);
            }
        });
        categoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(OrderCompletedActivity.this, CategoryActivity.class);
                startActivity(intent);
            }
        });
    }
